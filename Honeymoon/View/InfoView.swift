...
struct AppInfoView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            RowAppInfoView(itemOne: "Compability", itemTwo: "iPhone & iPad")
            RowAppInfoView(itemOne: "Developer", itemTwo: "YukiseKimi")
            RowAppInfoView(itemOne: "Designer", itemTwo: "Manny C.")
            RowAppInfoView(itemOne: "Website", itemTwo: "Github")
